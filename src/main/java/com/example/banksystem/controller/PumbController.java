...
public class PumbController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        Optional<BankType> bankType = bankTypeDao.get(3);       // <=====

        Names.setText("Name bank : " + bankType.get().getName());
        minsum.setText("Minimal sum : " + bankInfoList.get(2).getMinSum() );
        Maxsum.setText("Maximal sum : " + + bankInfoList.get(2).getMaxSum());
        minterm.setText("Minimal term : " + + bankInfoList.get(2).getMinTerm());
        maxterm.setText("Maximal term : " + + bankInfoList.get(2).getMaxTerm());
        percent.setText("Percent : " + bankInfoList.get(2).getPercent());
    }
