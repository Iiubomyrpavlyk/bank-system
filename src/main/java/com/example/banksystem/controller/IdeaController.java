...
public class IdeaController implements Initializable  {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        Optional<BankType> bankType = bankTypeDao.get(4);
        Names.setText("Name bank : " + bankType.get().getName());
        minsum.setText("Minimal sum : " + bankInfoList.get(3).getMinSum() );
        Maxsum.setText("Maximal sum : " + + bankInfoList.get(3).getMaxSum());
        minterm.setText("Minimal term : " + + bankInfoList.get(3).getMinTerm());
        maxterm.setText("Maximal term : " + + bankInfoList.get(3).getMaxTerm());
        percent.setText("Percent : " + bankInfoList.get(3).getPercent());
